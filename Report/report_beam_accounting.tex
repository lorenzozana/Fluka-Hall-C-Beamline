...
\item Material
\end{itemize}
See table \ref{tab:1} for the infos used in this example.
\begin{center}
\begin{table}[!h]
\begin{scriptsize}
...
\end{tabular}
\end{scriptsize}
\caption{Beamline properties to be transfered in Fluka}
\label{tab:1}
\end{table}
\end{center}
...
\item Energy(GeV)
\end{itemize}
See Table \ref{tab:2} for the beamtime for this experiment.
\begin{center}
\begin{table}[!h]
...
\section{Results}
Results were calculated after each target and after the full experiment. Activation was calculated in the volume surrounding the beamline with a granularity of a cube of 10cm size:
\begin{itemize}
